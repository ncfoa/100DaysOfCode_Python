...
sleep(45)
print("end sleep")
like_you = driver.find_element_by_xpath('/html/body/div[2]/div/div/div/div[3]/button[2]')
like_you.click()
count = 0
...
def window_click():
    sleep(1)
    driver.find_element_by_xpath('/html/body/div[1]/div/div[1]/div/main/div[1]/div/div/div[1]/div[1]/div[2]/div[4]/button').click()
    sleep(1)
...
for n in range(100):
    ...
    try:
        window_click()
    # // *[ @ id = "o-441539182"] / div / div / div / div[3] / button[2]
    except ElementClickInterceptedException:
        print("errored")

            # Catches the cases where there is a "Matched" pop-up in front of the "Like" button
        try:
            driver.find_element_by_xpath('/html/body/div[1]/div/div[1]/div/main/div[2]/div/div/div[1]/div/div[4]/button/svg/path').click()
